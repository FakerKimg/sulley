...
from requests import regular_datas
...
sess.connect(sess.root, s_get("regular data example 000"))


_file = open("/home/swpotato/dcns/sulley/test_datas", "w")
sess.fuzz(_file=_file)
