...
class FSM_based_Generator(object):
    ...
    def output_cases(self, valid, filename):
        _ggg, output_paths = generate_patterns(input_type, scc_type, condense_type, False, self.tr.correct_graph, self.tr.incorrect_graph, self.dead_state)
